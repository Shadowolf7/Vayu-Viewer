...
//#define LL_PROFILER_CATEGORY_ENABLE_FILE        1
...
#define LL_PROFILER_CATEGORY_ENABLE_WEBSOCKET   1
#define LL_PROFILER_CATEGORY_ENABLE_SCRIPTDEV   1
...
#if LL_PROFILER_CATEGORY_ENABLE_FILE
#define LL_PROFILE_ZONE_NAMED_CATEGORY_FILE  LL_PROFILE_ZONE_NAMED
#define LL_PROFILE_ZONE_SCOPED_CATEGORY_FILE LL_PROFILE_ZONE_SCOPED
#else
#define LL_PROFILE_ZONE_NAMED_CATEGORY_FILE(name)
#define LL_PROFILE_ZONE_SCOPED_CATEGORY_FILE
#endif
...
#if LL_PROFILER_CATEGORY_ENABLE_WEBSOCKET
    #define LL_PROFILE_ZONE_NAMED_CATEGORY_WEBSOCKET  LL_PROFILE_ZONE_NAMED
    #define LL_PROFILE_ZONE_SCOPED_CATEGORY_WEBSOCKET LL_PROFILE_ZONE_SCOPED
#else
    #define LL_PROFILE_ZONE_NAMED_CATEGORY_WEBSOCKET(name)
    #define LL_PROFILE_ZONE_SCOPED_CATEGORY_WEBSOCKET
#endif

#if LL_PROFILER_CATEGORY_ENABLE_SCRIPTDEV
    #define LL_PROFILE_ZONE_NAMED_CATEGORY_SCRIPTDEV  LL_PROFILE_ZONE_NAMED
    #define LL_PROFILE_ZONE_SCOPED_CATEGORY_SCRIPTDEV LL_PROFILE_ZONE_SCOPED
#else
    #define LL_PROFILE_ZONE_NAMED_CATEGORY_SCRIPTDEV(name)
    #define LL_PROFILE_ZONE_SCOPED_CATEGORY_SCRIPTDEV
#endif
