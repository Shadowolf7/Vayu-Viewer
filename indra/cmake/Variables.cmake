...
# Select arch based on requested target processor or macOS architecture
if(CMAKE_OSX_ARCHITECTURES)
  if(CMAKE_OSX_ARCHITECTURES MATCHES "arm64|aarch64")
    set(ARCH arm64)
    set(BUILD_TARGET_IS_ARM64 ON CACHE INTERNAL "ARM64 BUILD" FORCE)
    set(BUILD_TARGET_IS_X86_64 OFF CACHE INTERNAL "X86_64 BUILD" FORCE)
  else()
    set(ARCH x86_64)
    set(BUILD_TARGET_IS_X86_64 ON CACHE INTERNAL "X86_64 BUILD" FORCE)
    set(BUILD_TARGET_IS_ARM64 OFF CACHE INTERNAL "ARM64 BUILD" FORCE)
  endif()
else()
