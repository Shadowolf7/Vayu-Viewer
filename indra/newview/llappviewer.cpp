...
const std::string INITED_MARKER_FILE_NAME("Vayu.inited_marker");
const std::string CLOSE_EVENT_MARKER_FILE_NAME("Vayu.close_marker");
...
namespace
{
    ...
    std::string getStartupLogFileName()
    {
        ...
        return gDirUtilp->getExpandedFilename(LL_PATH_LOGS, "Vayu.log");
    }
    ...
    std::string getActiveLogFileName()
    {
        ...
        if (log_file.empty())
        {
            log_file = gDirUtilp->getExpandedFilename(LL_PATH_LOGS, "Vayu.log");
        }
        return log_file;
    }
} // anonymous namespace
