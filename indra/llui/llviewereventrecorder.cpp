...
LLViewerEventRecorder::LLViewerEventRecorder() {
  ...
  std::string old_log_ui_events_to_llsd_file = gDirUtilp->getExpandedFilename(LL_PATH_LOGS, "Vayu_Events_log.old");

  mLogFilename = gDirUtilp->getExpandedFilename(LL_PATH_LOGS, "Vayu_Events_log.llsd");
