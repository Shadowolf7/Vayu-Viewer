...
vcpkg_cmake_configure(
    ...
    OPTIONS
        ...
        -DSDL_RPI=OFF
        -DSDL_SNDIO=OFF
        # Vayu overlay: upstream forces this OFF for build reproducibility (vcpkg#53196),
        # but indra/cmake/SDL3.cmake already hard-requires libdecor-0 on the host, so
        # enabling it here doesn't reintroduce that non-determinism. Without this, Wayland
        # compositors with no server-side decorations (GNOME/Mutter, Weston) get borderless
        # windows with no way to move/resize/close them.
