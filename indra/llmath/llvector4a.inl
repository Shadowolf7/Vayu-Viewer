...
inline void LLVector4a::setCross3(const LLVector4a& a, const LLVector4a& b)
{
    ...
    mQ = _mm_fnmadd_ps( vector3, vector4, mQ );
#elif defined(__ARM_NEON) || defined(__aarch64__)
    mQ = vmlsq_f32( mQ, vector3, vector4 );
#else
...
#elif defined(__ARM_NEON) || defined(__aarch64__)
    const LLQuad threeMinusAtimesRsqrtTimesRsqrt = vmlsq_f32(vdupq_n_f32(3.f), AtimesRsqrt, rsqrt);
#else
